"""
Filename: adc_excitation_voltage_analysis.py

Description:
    Analysis module for comparing excitation voltage stability between HX711 and MCP3564 ADCs.
    Loads and processes voltage readings from CSV files, calculates statistical metrics,
    and generates visualizations for voltage stability and frequency characteristics.
    Used for evaluating the suitability of different ADCs for load cell measurements.
...
def analyze_adc_data(hx711_file, mcp_file):
    """
    Analyze and compare voltage stability data from HX711 and MCP3564 ADCs.
    
    Parameters:
        hx711_file (str): Path to CSV file containing HX711 voltage readings.
        mcp_file (str): Path to CSV file containing MCP3564 voltage readings.
    """
    # Load the CSV files
