"""
Filename: six_axis_evaluation.py

Description:
    Evaluation module for comparing calibration methods for 6-axis force/torque sensors.
    Implements basic single-point calibration, averaging calibration, and optimization-based 
    calibration approaches, and compares their performance across multiple test scenarios.
    Provides performance metrics and numerical comparisons to determine the most effective 
    calibration approach for multi-axis cross-talk compensation.
...
def evaluate_performance(estimated, actual):
    """
    Calculate performance metrics for calibration method evaluation.
    
    Parameters:
        estimated (np.ndarray): Estimated force/torque values.
        actual (np.ndarray): Actual force/torque values.
        
    Returns:
        tuple: Tuple containing mean relative error percentage and R² score.
    """
...
def average_calibration_matrix(*matrices):
    ...
    Parameters:
        *matrices: Variable number of calibration matrices to average.
